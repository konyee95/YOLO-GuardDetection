# USAGE 
# python3  mongo9.py --yolo yolo-guard
...
vs = cv2.VideoCapture()
vs.open("rtsp://it:admin123@10.2.13.10:554/Streaming/Channels/101/")
(W,H) = (None, None)
...
while True:
    ...
    if len(idxs) > 0:
        ...
        for i in idxs.flatten():
            ...
            gdata = {"place":"Factory 9", "time":datetime.datetime.now() , "guard_exist":True, "time_duration":guardSeenDuration}
